...
module "lambda_functions" {
  ...
  vpc_subnet_ids         = contains(["createUser", "getUserById", "googleLogin"], each.value.name) ? [] : data.aws_subnets.lambdas_subnets.ids
  vpc_security_group_ids = contains(["createUser", "getUserById", "googleLogin"], each.value.name) ? [] : [module.security_groups.lambda_sg_id]
